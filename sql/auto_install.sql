...
CREATE TABLE `civicrm_committee` (
  ...
  `name` varchar(255) COMMENT 'Committee Name (e.g. Communications)',
...
CREATE TABLE `civicrm_committee_role` (
  ...
  `name` varchar(255) COMMENT 'Committee Role (e.g. Chair)',
  `is_active` tinyint COMMENT 'Is this committee role enabled?',
  PRIMARY KEY (`id`)
)
ENGINE=InnoDB;
...
CREATE TABLE `civicrm_committee_appointment` (
  ...
  `committee_id` int unsigned COMMENT 'FK to Committee',
